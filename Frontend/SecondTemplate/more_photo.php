...
$obj_more_photo = new Frontend_view();
$photo = $obj_more_photo->all_more_photo_info();
...
<html lang="en">
  ...
  <head>
    ...
    <title>Bridal Pavilion || Photo Gallery</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="more_photo.php">Bridal Pavilion</a>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        <h1 class="text-uppercase mb-0">Photo Gallery</h1>
      </div>
    </header>
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Photo</h2>
